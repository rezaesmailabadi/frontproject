                            ...
                            <div className="section trending-ads">
                                <div className="section-title tab-manu">
                                    ...
                                    <ul className="nav nav-tabs" role="tablist">
                                        <li role="presentation"><a className="active" href="#recent-ads" data-toggle="tab">آخرین آگهی‌ها</a></li>
                                        <li role="presentation"><a href="#popular" data-toggle="tab">محبوبترین آگهی‌ها</a></li>
                                        <li role="presentation"><a href="#hot-ads" data-toggle="tab">پربازدیدترین آگهی‌ها</a></li>
                                    </ul>
                                </div>
